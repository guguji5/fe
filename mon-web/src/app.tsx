              ...
              <Switch>
                ...
                >
                  <Switch>
                    ...
                    <PrivateRoute
                      exact
                      path="/history/:historyType/:historyId"
                    ...
                    <PrivateRoute
                      exact
                      path="/nginx"
                      component={NginxLog as any}
                    />
                    <PrivateRoute
                      exact
                      path="/nginx/add"
                      component={NginxLogAdd as any}
                    />
                    <PrivateRoute
                      exact
                      path="/binlog"
                      component={Binlog as any}
                    />
                    <PrivateRoute
                      exact
                      path="/binlog/add"
                      component={BinlogAdd as any}
                    />
                    <PrivateRoute
                      exact
                      path="/strategy/:strategyId/clone"
                      component={StrategyClone}
                    />
                    <PrivateRoute
                      exact
                      path="/strategy/:strategyId"
                      component={StrategyModify}
                    />
                    <PrivateRoute exact path="/silence" component={Silence} />
                    <PrivateRoute
                      exact
                      path="/silence/add"
                      component={SilenceAdd}
                    />
                    <PrivateRoute
                      exact
                      path="/collect/:type"
                    ...
                    <PrivateRoute
                      exact
                      path="/collect-rules/:type"
                      component={CollectRuleForm as any}
                    />
                    <PrivateRoute
                      exact
                      path="/collect-rules"
                      component={CollectRule as any}
                    />
                    <PrivateRoute
                      exact
                      path="/collect/:action/:type"
                      component={CollectFormMain}
                    />
                    <PrivateRoute
                      exact
                      path="/collect/:action/:type/:id"
                      component={CollectFormMain}
                    />
